 ...
 */
final class Version20190508092238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE garden (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(60) NOT NULL, address LONGTEXT NOT NULL, zipcode VARCHAR(5) NOT NULL, city VARCHAR(60) NOT NULL, address_specificities LONGTEXT DEFAULT NULL, meters INT NOT NULL, number_plots_row INT NOT NULL, number_plots_column INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

 ...
 */
final class Version20190515073904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE garden ADD charte VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE market_offer (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, vegetable_id INT DEFAULT NULL, garden_id INT NOT NULL, quantity SMALLINT NOT NULL, unity VARCHAR(20) NOT NULL COLLATE utf8mb4_unicode_ci, pickup_date DATETIME DEFAULT NULL, pickup_place LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_E2F8384BA76ED395 (user_id), INDEX IDX_E2F8384B39F3B087 (garden_id), INDEX IDX_E2F8384B3D33F4D6 (vegetable_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
